 ...
 */
public class AlbumLoader extends WrapperAsyncTaskLoader<List<Album>> {
    ...
    public List<Album> loadInBackground() {
        ...
        Cursor mCursor = makeArtistAlbumCursor(getContext());
    ...
    public static final Cursor makeArtistAlbumCursor(final Context context) {
        return context.getContentResolver().query(Audio.Albums.EXTERNAL_CONTENT_URI,
                new String[] {
                        /* 0 */
                        BaseColumns._ID,
                        /* 1 */
